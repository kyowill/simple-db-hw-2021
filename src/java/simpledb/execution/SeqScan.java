...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
        ...
        TupleDesc nTupleDesc = new TupleDesc();
        Iterator<TupleDesc.TDItem> iter = tupleDesc.iterator();
        List<TupleDesc.TDItem> tdItemList = new ArrayList<>();
        while (iter.hasNext()) {
            TupleDesc.TDItem tdItem = iter.next();
            TupleDesc.TDItem item = new TupleDesc.TDItem(tdItem.fieldType, tableAlias + "." + tdItem.fieldName);
            tdItemList.add(item);
        }
        nTupleDesc.setTDItems(tdItemList);
        return nTupleDesc;
    }
