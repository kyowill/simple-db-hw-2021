...
public class JoinOptimizer {
    ...
    static final float UN_EQ_FREQ = 0.3f;
    ...
    public static int estimateTableJoinCardinality(Predicate.Op joinOp,
        ...
        TableStats tableStats1 = stats.get(table1Name);
        TableStats tableStats2 = stats.get(table2Name);
        DbFile table1 = Database.getCatalog().getDatabaseFile(tableId1);
        DbFile table2 = Database.getCatalog().getDatabaseFile(tableId2);
